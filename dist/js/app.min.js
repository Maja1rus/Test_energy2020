...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_menu_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/menu.js */ \"./src/js/modules/menu.js\");\n/* harmony import */ var _modules_bg_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/bg.js */ \"./src/js/modules/bg.js\");\n\n\n\n// menu\ntry {\n    const header = document.querySelector('.header');\n    if (header) {\n        (0,_modules_menu_js__WEBPACK_IMPORTED_MODULE_0__.menu)(header)\n    }\n} catch (error) {\n    console.log(error);\n}\n\n\ntry {\n    const bg = document.querySelector('.bg-top');\n    if (bg) {\n        (0,_modules_bg_js__WEBPACK_IMPORTED_MODULE_1__.changeColor)(bg, 1)\n    }\n} catch (error) {\n    console.log(error);\n}\n\n//# sourceURL=webpack://gulp-lite/./src/js/app.js?");
